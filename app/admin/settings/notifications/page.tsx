...
export default function AdminNotificationSettings() {
  ...
  useEffect(() => {
    console.log("Admin context settings updated:", contextSettings)
    setSettings(contextSettings)
  }, [contextSettings])

  const handlePushToggle = (setting: keyof PushNotificationSettings) => {
    console.log(
      `Admin toggling ${setting} from ${settings.pushNotifications[setting]} to ${!settings.pushNotifications[setting]}`,
    )
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-xl font-semibold text-black">Admin Notification Preferences</h2>
      ...
      {process.env.NODE_ENV === "development" && (
        <div className="mb-6 p-4 bg-gray-100 rounded-md">
          <h4 className="font-medium mb-2">Admin Debug Info:</h4>
